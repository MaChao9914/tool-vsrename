...
namespace VSRename
{
    internal class Program
    {
        ...
        {
            Console.Write(".");
            if (path.Contains(".svn") || path.Contains(".nuget") || path.Contains("packages") || path.Contains("obj") || path.Contains("bin") || path.Contains(".git") || path.Contains("DataHubRefDll")) return;
